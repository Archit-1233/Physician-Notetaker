...
def extract_current_status(text):
    status_phrases = load_phrases(r"C:\Users\agraw\OneDrive\Desktop\Physician_project\app\status_phrases.txt")
...
def extract_prognosis(text):
    prognosis_phrases = load_phrases(r"C:\Users\agraw\OneDrive\Desktop\Physician_project\app\prognosis_phrase.txt")
